									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<div class="input-group">										  
											   <input type="text" class="form-control" id="id_discount_group_<?php echo $k;?>" placeholder="0" name="id_discount_group_<?php echo $k;?>" value="<?php echo $v['value'];?>" aria-describedby="sizing-addon<?php echo $k;?>">
