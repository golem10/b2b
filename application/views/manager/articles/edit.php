  ...
  <div class="panel-body">
	<form class="form-horizontal w700" method="post">
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="title" class="form-control"  placeholder="Tytuł" name="title" <?php echo (isset($post['title'])) ? 'value="'.$post['title'].'"' : 'value="'.$article['title'].'"' ?> >
			</div>
			<label class="control-label" for="text">Treść</label>
			<div class="controls">
				<textarea id="title" class="form-control"  placeholder="Treść" name="text" ><?php echo (isset($post['title'])) ? $post['title'] : $article['text']; ?> </textarea>
			</div>
		</div>
		<br/>
		<div class="control-group">
