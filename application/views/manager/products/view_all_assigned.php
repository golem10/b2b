...
<div id="main-content">
	<div class="panel panel-default">
	  <div class="panel-heading">
		<span class="panel-header">Przypisane produkty</span>
	  </div>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" id="modalDelete">
	  <div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form action="<?php echo base_url($path."products/delProduct/?news=1");?>" method="post" class="center">
...
$('#products-table').dataTable( {
		...
		"bProcessing": true,
		 "bServerSide": true,
		 "sAjaxSource": "<?php echo base_url("manager/tabledata/products_all_assigned/");?>", 
